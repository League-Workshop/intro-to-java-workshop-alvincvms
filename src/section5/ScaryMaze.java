...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("DERP.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
	    ...
	    if(mouseColor != -1 ) {
	    		if(mouseColor != -16715521) {
	    			scare();// call the scare method
	    			
	    		}
	    }
		//13. If the mouse is on the end color
		if(mouseColor == -1507071) {
				JOptionPane.showMessageDialog(null, "Nice");// pop up a message to tell them they won
		}
}
